export const circuits: Circuit[] = [
  ...
  },
  {
    ...
    image: {
      url: "https://www.formula1.com/content/dam/fom-website/manual/Misc/2020/New-Races/DJI_0560.jpg.transform/9col/image.jpg",
      width: 997,
      height: 561,
    },
  ...
  },
  {
    ...
    description: 'The Yas Marina circuit in Abu Dhabi, capital of the United Arab Emirates, is believed to be the most expensive F1 track ever built, with a reputed construction cost in 2009 in excess of €800m ($1bn).No expense was spared for the construction of the purpose-built facility on a man-made island. Its most distinctive feature is the Yas Viceroy Abu Dhabi Hotel which sits atop the track, and bridges it between turns 18 and 19. Another unique feature is the pit lane exit, which passes underneath the circuit by means of a tunnel.The generally slow nature of the layout, despite two long straights, means it has been slow to win favour with drivers. However the top-class nature of its facilities, such as the luxury of air-conditioned garages, makes it popular with paddock inhabitants. And the unique spectacle of sun setting during the races makes for a picturesque venue.Two changes to the track’s layout are being made for its race at the end of the 2021 F1 season.',
    image: {
      url: 'https://www.formula1.com/content/dam/fom-website/manual/Misc/2021manual/AbuDhabiTrack/YMC-New-Track-A.jpg',
      width: 1920,
      height: 1080,
    },
    location: {
